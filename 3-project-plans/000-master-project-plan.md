...
| 060 | [[060-multiple-columns\|Multiple Columns]] | 🔄 IN PROGRESS | Multi-column layout for lists | Display lists in multiple columns (2-3 columns). Extends milestone 050 - drag-and-drop and keyboard navigation must work across columns. |
